...
('A101', 'Amphithéâtre A', 150, 'Bâtiment A', 1, 1),
('A102', 'Salle A102', 50, 'Bâtiment A', 1, 1),
('B201', 'Salle B201', 40, 'Bâtiment B', 2, 1),
('B202', 'Salle B202', 40, 'Bâtiment B', 2, 1),
('TP-CHIMIE', 'Labo Chimie', 25, 'Bâtiment C', 1, 1),
('TP-INFO', 'Labo Informatique', 30, 'Bâtiment C', 1, 1);
...
(1, 2, 'Bienvenue', 'Bienvenue sur le système de messagerie CUK-Admin.', NULL),
(2, 1, 'Question inscription', 'Bonjour, pourriez-vous vérifier le dossier de l''étudiant Nguema Sonia ?', NULL);
