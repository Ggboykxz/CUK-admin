...
/**
 * Stub for Dompdf when the real library is not installed via Composer.
 * Only loaded when dompdf/dompdf is not available.
 */
if (!class_exists('Dompdf\Dompdf', false)) {
    ...
    class_alias(DompdfStub::class, 'Dompdf\Dompdf');
